    ...
    return (
        ...
        >
            ...
            <p className="mx-auto max-w-[600px] p-2 text-xl text-[#949494]">
                ...
                studying <span className="text-white">Computer Science</span> at
                the <span className="text-white">University of Victoria</span>.
                Scroll below to learn more about me.
            </p>
            <button
                onClick={() =>
                    window.open("https://calendly.com/jasdhaul0", "_blank")
                }
