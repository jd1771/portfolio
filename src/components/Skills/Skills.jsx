        ...
        <div className="container mx-auto mt-10 px-5 py-10" id="skills">
            <div className="mb-20 text-center">
                ...
                <p className="text-md mx-auto leading-relaxed text-white md:text-xl lg:w-3/4 xl:w-2/4">
                    A showcase of my skills and technological expertise,
                    highlighting my the range of technical skills I possess,
                    from programming languages and frameworks to software
